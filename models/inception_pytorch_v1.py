...
class googlenet(nn.Module):
    def __init__(self, in_channels = 3, num_classes = 1000):
        ...
        self.inception3a = inception_block(in_channels = 192, 
                                           out_1x1 = 64, 
                                           red_3x3 = 96, 
                                           out_3x3 = 128, 
                                           red_5x5 = 16, 
                                           out_5x5 = 32, 
                                           out_1x1pool = 32)
        self.inception3b = inception_block(256, 128, 182, 192, 32, 96, 64)
...
class inception_block(nn.Module):
    def __init__(self, in_channels, out_1x1, red_3x3, out_3x3, red_5x5, out_5x5, out_1x1pool):
       ...
       self.branch2 = nn.Sequential(
           conv_block(in_channels, red_3x3, padding = 0, kernel_size=1),
